    ...
    return (
        <section className="projects" id="projects">
            <div className="projects-content">
                <h2>Projects</h2>
                <div className="project" href="https://github.com/BLewis-Keyin/Flight-Data-Portal">
                ...
                <div className="project" href="https://github.com/BLewis-Keyin/RedditVideoScraper">
